...
public class DateInformCustomer extends RelativeLayout implements View.OnClickListener, OnDateChangedListener, OnTimeChangedListener {
	...
	// Constructor start
	public DateInformCustomer(Context context) {
		this(context, null);
	}

	public DateInformCustomer(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public DateInformCustomer(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

		// Get LayoutInflater instance
		final LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		// Inflate myself
		inflater.inflate(R.layout.date_inform_customer, this, true);
		...
		viewSwitcher = (ViewSwitcher) this.findViewById(R.id.switch_view);
		...
		((Button) findViewById(R.id.btn_set_time)).setOnClickListener(this); // shows the time picker
