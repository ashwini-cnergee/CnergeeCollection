...
public class ValidateChqReceiptCaller extends Thread {
	...
	public ValidateChqReceiptCaller() {
	}

	public ValidateChqReceiptCaller(String WSDL_TARGET_NAMESPACE,
	...
	public void run() {
		...
		try {
			...
			ChequeActivity.isValid = validateReceiptSOAP.ValidateReceiptNo(Authobj);
			ChequeActivity.rslt = "ok";

		} catch (Exception e) {
			ChequeActivity.rslt = e.toString();
		}
	}
